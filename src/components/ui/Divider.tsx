...
>(({ className, orientation = "horizontal", variant, thickness, spacing, decorative = true, ...props }, ref) => (
  ...
  ({ 
    ...
    return (
      <div
        ...
        {...props}
      >
        <div className={cn('flex w-full items-center', labelPositionStyles[labelPosition])}>
          {labelPosition !== 'left' && (
            <Separator
              className="flex-1"
