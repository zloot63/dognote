...
const Grid = React.forwardRef<HTMLDivElement, GridProps>(
  ({ className, cols, gap, responsive, children, ...props }, ref) => {
    const responsiveClasses = responsive
      ? [
          responsive.sm &&
            `sm:grid-cols-${responsive.sm === 'auto' ? 'auto' : responsive.sm === 'fit' ? 'fit' : responsive.sm}`,
          responsive.md &&
            `md:grid-cols-${responsive.md === 'auto' ? 'auto' : responsive.md === 'fit' ? 'fit' : responsive.md}`,
          responsive.lg &&
            `lg:grid-cols-${responsive.lg === 'auto' ? 'auto' : responsive.lg === 'fit' ? 'fit' : responsive.lg}`,
          responsive.xl &&
            `xl:grid-cols-${responsive.xl === 'auto' ? 'auto' : responsive.xl === 'fit' ? 'fit' : responsive.xl}`,
        ]
          .filter(Boolean)
          .join(' ')
      : '';
