        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/walks" className="text-gray-600 hover:text-gray-900 transition-colors">
                  산책 추적
                </Link>
              </li>
              <li>
                <Link href="/health" className="text-gray-600 hover:text-gray-900 transition-colors">
                  건강 관리
                </Link>
              </li>
              <li>
