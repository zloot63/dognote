      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="p-6 border-2 border-neutral-300">
            ...
            <p className="mb-4">
              DogNote의 스페이싱 시스템은 4px 그리드를 기반으로 합니다. 이는
              일관된 UI를 구축하고 요소 간의 관계를 명확하게 하는 데 도움이
              됩니다.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="p-6 space-y-6 border-2 border-neutral-300">
            ...
            <div className="space-y-4">
              <div>
                <div className="p-2 bg-neutral-100 dark:bg-neutral-800 border border-dashed border-neutral-300 dark:border-neutral-600">
              ...
              <div>
                <div className="p-4 bg-neutral-100 dark:bg-neutral-800 border border-dashed border-neutral-300 dark:border-neutral-600">
                  <div className="bg-primary-100 dark:bg-primary-900 p-6 text-center">
                    p-4 (외부), p-6 (내부)
                  </div>
                </div>
                <code className="text-xs text-neutral-500 mt-1 block">
              ...
              <div>
                <div className="px-4 py-2 bg-neutral-100 dark:bg-neutral-800 border border-dashed border-neutral-300 dark:border-neutral-600">
                  <div className="bg-primary-100 dark:bg-primary-900 text-center py-1">
                    px-4 py-2 (외부), py-1 (내부)
                  </div>
                </div>
                <code className="text-xs text-neutral-500 mt-1 block">
                  버튼과 같은 인라인 요소에 적합한 패딩
                </code>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6 space-y-6 border-2 border-neutral-300">
            ...
            <div className="space-y-4">
              <div>
                <div className="space-y-2 bg-neutral-100 dark:bg-neutral-800 p-4 border border-dashed border-neutral-300 dark:border-neutral-600">
                  <div className="bg-primary-100 dark:bg-primary-900 p-2 text-center">
                    항목 1
                  </div>
                  <div className="bg-primary-100 dark:bg-primary-900 p-2 text-center">
                    항목 2
              ...
              <div>
                <div className="flex gap-4 bg-neutral-100 dark:bg-neutral-800 p-4 border border-dashed border-neutral-300 dark:border-neutral-600">
                  <div className="bg-primary-100 dark:bg-primary-900 p-2 flex-1 text-center">
                    항목 1
                  </div>
                  <div className="bg-primary-100 dark:bg-primary-900 p-2 flex-1 text-center">
                    항목 2
              ...
              <div>
                <div className="grid grid-cols-3 gap-2 bg-neutral-100 dark:bg-neutral-800 p-4 border border-dashed border-neutral-300 dark:border-neutral-600">
                  <div className="bg-primary-100 dark:bg-primary-900 p-2 text-center">
                    1
                  </div>
                  <div className="bg-primary-100 dark:bg-primary-900 p-2 text-center">
      ...
      <section className="space-y-4">
        ...
        <Card className="p-6 border-2 border-neutral-300">
          ...
          <div className="mb-6">
            ...
            <div className="p-2 sm:p-4 md:p-6 lg:p-8 bg-neutral-100 dark:bg-neutral-800 border border-dashed border-neutral-300 dark:border-neutral-600">
              <div className="bg-primary-100 dark:bg-primary-900 p-4 text-center">
                화면 크기에 따라 패딩이 변경됩니다
              </div>
            </div>
