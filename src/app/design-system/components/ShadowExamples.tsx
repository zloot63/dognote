    ...
    <div className="space-y-10">
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="p-6 border-2 border-neutral-300">
            ...
            <p className="mb-4">
              그림자는 UI 에서 깊이와 계층을 표현하는 중요한 요소입니다. 요소
              간의 관계와 중요도를 시각적으로 전달하고, 사용자가 인터페이스를 더
              직관적으로 이해할 수 있도록 도와줍니다.
            </p>
          ...
          <Card className="p-6 border-2 border-neutral-300">
            ...
            <ul className="list-disc pl-5 space-y-2 text-neutral-700 dark:text-neutral-300">
              <li>
                <span className="font-medium">수평 오프셋</span>: 그림자의 수평
                위치
              </li>
              <li>
                <span className="font-medium">수직 오프셋</span>: 그림자의 수직
                위치
              </li>
              <li>
                <span className="font-medium">블러 반경</span>: 그림자의 흐림
                정도
              </li>
              <li>
              ...
              <li>
                <span className="font-medium">색상 및 투명도</span>: 그림자의
                색상과 강도
              </li>
            </ul>
          </Card>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {Object.entries(boxShadow).map(([key]) => (
            <ShadowCard
              key={key}
              name={key}
          ...
          <Card className="p-6 space-y-6 border-2 border-neutral-300">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500 mt-2">
                  모달과 드롭다운은 다른 요소 위에 떠있는 느낌을 주기 위해 lg
                  그림자를 사용합니다.
                </p>
              </div>
            </div>
      ...
      <section className="space-y-4">
        ...
        <Card className="p-6 border-2 border-neutral-300">
          ...
          <p className="mb-4">
            다크 모드에서는 그림자의 가시성과 효과가 다르게 나타납니다. 밝은
            배경에서는 어두운 그림자가 잘 보이지만, 어두운 배경에서는 그림자의
            대비가 줄어듭니다.
          </p>
...
function ShadowCard({ name, copiedText, onCopy }: ShadowCardProps) {
