...
function FontFamilyCard({
  ...
  return (
    <Card className="overflow-hidden border-2 border-neutral-300">
      <div className="p-4 bg-neutral-50 dark:bg-primary-600 border-b border-neutral-200 dark:border-neutral-700 flex justify-between items-center">
        <div>
      ...
      <div className={cn('p-4', isMono ? 'font-mono' : 'font-sans')}>
