  ...
  return (
    <div className={`space-y-8 ${className}`}>
      <div>
        ...
        <p className="mb-4">
          DogNote 디자인 시스템은 일관된 색상 사용을 위한 컬러 팔레트를
          제공합니다. 각 색상은 50부터 950까지의 음영을 가지며, 다양한 상황에
          맞게 사용할 수 있습니다.
        </p>
            ...
            <div key={scale} className="space-y-2">
              ...
              <div className="grid grid-cols-11 gap-2">
                {shades.map(shade => {
                  ...
                  const colorValue =
                    colorScale?.[shade as keyof typeof colorScale];
        ...
        <div className="mt-6 p-4 bg-neutral-50 rounded-lg">
          ...
          <ul className="list-disc pl-5 space-y-1 text-sm text-neutral-700">
            <li>
              <strong>Primary</strong>: 주요 브랜드 색상, 중요 버튼, 강조 요소
            </li>
            <li>
              <strong>Secondary</strong>: 보조 브랜드 색상, 보조 버튼, 보조 강조
            </li>
            <li>
              <strong>Neutral</strong>: 텍스트, 배경, 구분선 등 중립적 요소
            </li>
            <li>
              <strong>Success</strong>: 성공 메시지, 완료 상태, 긍정적 피드백
            </li>
            <li>
              <strong>Warning</strong>: 경고 메시지, 주의 필요 상태
            </li>
            <li>
              <strong>Error</strong>: 오류 메시지, 실패 상태, 부정적 피드백
            </li>
            <li>
              <strong>Info</strong>: 정보 메시지, 안내 상태
            </li>
          </ul>
        </div>
      </div>
