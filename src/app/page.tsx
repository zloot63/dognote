        ...
        <div className="relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              GPS 산책 추적, 건강 기록, 예방접종 관리까지.
              DogNote와 함께 반려견의 모든 순간을 기록하고 관리하세요.
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">GPS 산책 추적</h3>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  예방접종 일정, 건강 기록을 체계적으로 관리하고 알림을 받으세요.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">포인트 시스템</h3>
                <p className="text-gray-600">
