...
### 1.1 문서 목적
이 문서는 DogNote 애플리케이션의 기능적 요구사항을 정의하고, 개발팀과 이해관계자들이 제품의 기능과 동작을 명확히 이해할 수 있도록 합니다.
...
### 2.1 제품 비전
> 반려견의 일상·건강·산책을 한곳에서 관리하고, 데이터 기반 인사이트와 보상을 제공하는 **"반려견 라이프로그 플랫폼"**
...
*이 문서는 지속적으로 업데이트되며, 모든 변경사항은 change-log.md에 기록됩니다.*
